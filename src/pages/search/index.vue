      ...
      <div class="py-container">
        ...
        <div class="bread">
          ...
          <ul class="fl sui-tag">
            ...
            <li class="with-x" v-if="searchParams.keywords">{{searchParams.keywords}}<i @click="removeKeywords">×</i></li>
            ...
            <div class="navbar-inner filter">
              <ul class="sui-nav">
                <li :class="{active:isOne}" @click="changeOrder(1)">
                  <a >综合 <span v-show="isOne" class="iconfont " :class="{'icon-direction-up':searchParams.order.indexOf('asc')!=-1,'icon-direction-down':searchParams.order.indexOf('desc')!=-1}"></span></a>
                </li>
                <li :class="{active:isTwo}" @click="changeOrder(2)">
                  <a >价格 <span v-show="isTwo" class="iconfont " :class="{'icon-direction-up':searchParams.order.indexOf('asc')!=-1,'icon-direction-down':searchParams.order.indexOf('desc')!=-1}"></span></a>
                </li>
              </ul>
            </div>
          </div>
