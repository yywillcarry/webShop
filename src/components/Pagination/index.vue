<template>
  <div class="pagination">
    ...
    <span v-for="(page,index) in startNumAndEndNum.end" :key="index"><button :class="{active:pageNo==page}"  v-if="page>=startNumAndEndNum.start"  @click="$emit('getPageNo',page)">{{page}}</button></span>
